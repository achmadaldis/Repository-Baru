...
public class ActivityKuis extends AppCompatActivity {
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            Toast.makeText(ActivityKuis.this, "It was the last question!", Toast.LENGTH_SHORT).show();
            Intent intent = new Intent(ActivityKuis.this, HasilKuis.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText() == mAnswer){
            mScore = mScore + 1;
            Toast.makeText(ActivityKuis.this, "Benar!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(ActivityKuis.this, "Salah!", Toast.LENGTH_SHORT).show();
